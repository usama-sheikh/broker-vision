                    ...
                    <div class="card bg-dark z-index-0 fadeIn3 fadeInBottom">
                        <div class="card-header bg-dark p-0 mt-n4 mb-0 p-3">
                            <div class="bg-dark border-radius-lg py-3 pe-1">
                                <h4 class="text-white font-weight-normal text-center mt-2 mb-0">Forgot Password</h4>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            ...
                            <form role="form" class="text-start" method="POST" action="{{ route('password.email') }}"
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn bg-gradient-primary w-100 my-2 mb-2">Email Password
                                        Reset Link
                                    </button>
                                </div>
                                <p class="text-sm text-end text-info">
                                    <a href="{{ route('login') }}" class="text-info text-gradient font-weight-bold">Login
                                        now?</a>
                                </p>
                            </form>
                        </div>
