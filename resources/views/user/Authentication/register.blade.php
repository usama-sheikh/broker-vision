                    ...
                    <div class="card bg-dark z-index-0 fadeIn3 fadeInBottom">
                        <div class="card-header bg-dark p-0 mt-n4 mb-0 p-3">
                            <div class="bg-dark border-radius-lg py-3 pe-1">
                                <h4 class="text-white font-weight-normal text-center mt-2 mb-0">Sign Up</h4>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            ...
                            <form role="form" class="text-start" method="POST" action="{{ route('register') }}" autocomplete="off">
                                ...
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <input type="number"
                                           @if(!empty(old('contact_no'))) value="{{ old('contact_no') }}" @endif
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn bg-gradient-primary w-100 my-2 mb-2">Sign Up
                                    </button>
                                </div>
